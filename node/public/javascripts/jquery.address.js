...
(function ($) {
    ...
    $.address = (function () {
        ...
        var _trigger = function(name) {
            ...
            _window = function() {
                try {                    // For learn.knockoutjs.com, we don't want the "live code" iframe to interfere with the main window                    // even though it could (it's on the same domain)                    return window; // Original code: return top.document !== UNDEFINED ? top : window;
                } catch (e) { 
                    return window;
                }
            },
